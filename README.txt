...
It has methods to add and get messages from these lists and updates this information across the other threads. It recieves and sends request
basically telling the elevator where to go.

-logging Class
the logging class is a custom built logging class. This logger prints all of the data and information received and sent from all of the classes and prints it ut in the console
