...
public class CloseDoors extends DoorState{
    ...
    public void entry(){
        super.entry();
        System.out.println(Thread.currentThread().getName() + " Doors closing for " + (ConfigInfo.DOOR_OPEN_TIME/1000) + " seconds on floor " + elevator.getCurrentFloor());
    ...
    public void timeout(){
        ...
        if(elevator.queueIsEmpty()){
            ...
            elevator.changeState(new MoveFloor(elevator));
        }
    }
}
